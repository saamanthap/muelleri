...
```
for i in $(ls *_out.vcf.geno) ; do python ~/genomics_general/popgenWindows.py -g ${i} -o ${i}.out --windType coordinate -f phased -w 1000000 -m 100 -p F -p M --popsFile pops_file.txt ; done 
